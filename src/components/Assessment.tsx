...
export default function Assessment() {
  ...
  return (
    <div className={`w-full ${!showIntro ? 'pt-24' : ''}`}>
      {showIntro ? (
        ...
        <div>
          {/* Progress indicator shown only when not loading */}
          {!isLoading && (
            <div className="max-w-2xl mx-auto mb-4">
              <div className="text-2xl font-bold text-blue-500 dark:text-blue-400 mb-3 font-['Lora']">
